...
class Enquete(models.Model):
    ...
    # reponses affichées ou non après l'enquête
    correction = models.BooleanField('correction', default=False)
    ordre_aleatoire = models.BooleanField('ordre aléatoire des énigmes', default=False)
